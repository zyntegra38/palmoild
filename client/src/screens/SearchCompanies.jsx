                    ...
                    {companies.map((company, index) => (
                      <div className="listing row-tab" key={company._id}>
                                ...
                                <b>
                                  ...
                                  <>
                                    <button 
                                      ...
                                      data-tooltip-content="Please subscribe"                                      
                                      disabled 
                                      className="font-lato hover:underline text-gray-600 text-sm">
                                      {company.company}
                                    </button>
                                  </>
                                  }
                        ...
                        <div className="w-4/12 inline-block text-right">
                          ...
                          <div className="brown">
                            <h3 className="font-lato hover:underline text-gray-600 text-sm" 
                                      data-tooltip-id="search-tooltip"
                                      data-tooltip-content="Please subscribe">{company.categoryName}</h3>
                          </div>
                        </div>
                      </div>
                    ))}
